        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="{{route('home')}}">Absen</a>
              @if (Auth::user()->role == 'admin')
                <a class="navbar-brand" href="{{route('view_employee')}}">Employee</a>
              @else
                <a class="navbar-brand" href="/employee/edit/{{Auth::user()->id}}">Edit Profile</a>
              @endif
            </div>
